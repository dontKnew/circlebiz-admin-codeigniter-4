    ...
    <div class="container-fluid pt-0 px-0 my-2">
        <div class="vh-100 bg-grey-l rounded p-4" style=" background-color:#f3f0f0 !important;">
            ...
            <div class="table-responsive" id="shipmentSearchData">
                <a href="<?= base_url("admin/blog-category/add") ?>" class="btn btn-info my-2"><i class="fas fa-plus-square mx-1 "></i>Add Category</a>
                <table class="table text-start align-middle table-bordered table-hover mb-0">
                    <thead>
                    <tr class="text-blue">
                        <th scope="col" class="btn-blue">Id</th>
                        <th scope="col" class="btn-blue">Post Category</th>
                    ...
                    <?php foreach($data as $value){ ?>
                        <tr class="text-dark bg-white">
                            ...
                            <td>
                                <a href="<?= base_url("admin/blog-category/".$value['id']) ?>"  class="btn btn-sm btn-danger"> <i class="fas fa-trash mx-1"></i> Delete </a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
            ...
            <div class="text-center">
                <a href="<?= base_url("admin/blog-category/add") ?>" class="btn btn-lg btn-warning my-2"><i class="fas fa-plus-square"></i> Add Category</a>
            </div>
            <?php endif;?>
        </div>
    </div>
